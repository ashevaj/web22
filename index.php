...
<p class="center_text"><a href="create.php" style="color: black">Create Plants</a></p>
<hr class="line">
...
<div class="icon_bar" id="photo_bar">
    ...
    foreach ($items as $item) { ?>
        <div class="plant_box">
            ...
            <a class="photo_price" style="color: black" href="update.php?ID=<?php echo $item['ID'] ?>">Update</a>
            <a class="photo_price" style="color: black" href="delete.php?ID=<?php echo $item['ID'] ?>">Delete</a>
        </div>
    <?php } ?>
</div>
